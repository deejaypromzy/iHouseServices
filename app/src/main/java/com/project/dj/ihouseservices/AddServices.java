...
private MKLoader progressBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] ITEMS = {"Electrical", "Plumbing", "Locksmith",
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            filePath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    Toast.makeText(AddServices.this, resultUri.toString(), Toast.LENGTH_SHORT).show();
...
//                            }
                            ...
                            .addOnFailureListener(new OnFailureListener() {
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    ...
                                    Toast.makeText(AddServices.this, "Error Updating , Check Internet Connectivity", Toast.LENGTH_SHORT).show();
                                    progressBar.setVisibility(View.GONE);
            ...
            case R.id.productImageBtn:
                ...
                { Toast.makeText(AddServices.this, "Uploading product picture.....", Toast.LENGTH_SHORT).show();
...
//                    .setAspectRatio(1, 1)
    ...
    boolean NoPermissions() {
        ...
        for (String s : permissions) {
            res = AddServices.this.checkCallingOrSelfPermission(s);
