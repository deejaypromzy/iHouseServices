 ...
 */
class ManageAdapter extends RecyclerView.Adapter<ManageAdapter.ChildViewHolder>  {
     ...
     */
    ManageAdapter(Context context, ArrayList<Child> sportsData) {
    ...
    public ChildViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ChildViewHolder(mContext, LayoutInflater.from(mContext).
                inflate(R.layout.manage_product_template, parent, false), mGradientDrawable);
    }
...
//            });
            ...
            call.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("seviceName",mCurrentChild.getName());
