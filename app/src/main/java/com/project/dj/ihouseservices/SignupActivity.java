...
public class SignupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] ITEMS = {"User","Service Provider"};
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                if (selectedItemView != null) {
                    ...
                    ((TextView) selectedItemView).setCompoundDrawablesWithIntrinsicBounds(AppCompatResources.getDrawable(getApplicationContext(), R.drawable.money2), null, null, null);
                    ((TextView) selectedItemView).setCompoundDrawablePadding(20);// to set drawablePadding
                    mgender = ((TextView) selectedItemView).getText().toString();
...
//                        }
            ...
            public void onNothingSelected(AdapterView<?> parentView) {
                // your code here
                spinner.setError("User-Type cant be empty");
