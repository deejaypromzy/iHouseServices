...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UserProfileEmail= navigationView.getHeaderView(0).findViewById(R.id.WelcomeEmail);
       UserProfileEmail.setText(fireuser.getEmail());


        if (Objects.equals(pref.getString("userType", null), "Admin")){
            navigationView.getMenu().clear();
            navigationView.inflateMenu(R.menu.activity_main_drawer);

        }else   if (Objects.equals(pref.getString("userType", null), "Service Provider")){
            navigationView.getMenu().clear();
            navigationView.inflateMenu(R.menu.selller);

        }else   if (Objects.equals(pref.getString("userType", null), "User")){
            navigationView.getMenu().clear();
...
//        collapsingToolbar.setTitle("iHouse Services");
...
//c.close();
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.BaseOnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                mSportsData.clear();
                loadBackdrop(tabLayout.getSelectedTabPosition());
                new CountDownTimer(2000,1000)
                {
                    public void onTick(long ms)
                    {
...
//        }
    ...
    private void loadBackdrop(int a) {
      //  final ImageView imageView = findViewById(R.id.backdrop);
       final KenBurnsView imageView = (KenBurnsView) findViewById(R.id.backdrop);
       // header.setImageResource(R.drawable.header);
        Glide.with(this).load(DropBack.getRandomChildDrawable(a)).into(imageView);
    }
    @Override
...
//                startActivity(intent);
        ...
        if (id == R.id.action_settings) {
            ...
            alertDialog.setTitle("iHouse Service");
